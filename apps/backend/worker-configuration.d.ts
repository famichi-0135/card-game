/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareBindings` (hash: a4cf0c629465f76bd06ba5975178fb90)
// Runtime types generated with workerd@1.20260708.1 2026-07-15 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	...
	GAME_SESSION: DurableObjectNamespace<import("./src/index").GameSession>;
	CATALOG_ARCHIVE: DurableObjectNamespace<import("./src/index").CatalogArchive>;
	MATCH_LOBBY: DurableObjectNamespace<import("./src/index").MatchLobby>;
	PLAYER_DECKS: DurableObjectNamespace<import("./src/index").PlayerDecks>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GameSession" | "MatchLobby" | "PlayerDecks" | "CatalogArchive";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "BETTER_AUTH_TRUSTED_ORIGINS" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
